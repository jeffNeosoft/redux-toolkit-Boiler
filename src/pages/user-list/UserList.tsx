...
import { getTenantUserList } from "../../actions/TenantActions";
...
export default function UserList() {
  ...
  const userList = useSelector((state: RootState) => state.setTenantUserList);
  const mainCall = (currentPage: number, searchUser: string) => {
    try {
      console.log(currentPage);
      getTenantUserList(currentPage, searchUser).then((res) => {
